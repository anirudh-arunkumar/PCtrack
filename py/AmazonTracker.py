...
url = 'https://www.amazon.com/s?i=videogames&bbn=468642&rh=n%3A20972797011&qid=1609818856&rd=1&ref=sr_pg_1'
...
with open('AmazonTest.html', 'w', encoding='utf8') as f:
...
try:
   ...
   saveFile = open('AmazonTest.html', 'w')
