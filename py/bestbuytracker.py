...
url = 'https://www.bestbuy.com/site/playstation-4-ps4/playstation-4-ps4-video-games/pcmcat296300050018.c?id=pcmcat296300050018'
...
with open('bestbuyPage1.html', 'w', encoding='utf8') as f:
...
try:
   ...
   saveFile = open('bestbuyPage1.html', 'w')
